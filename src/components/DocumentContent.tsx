...
export function DocumentContent() {
  ...
  const { data, isLoading, isError } = useCaseDetails({
    caseId: template, // Use the caseId from the template data or URL params
    attorneyId: id?.attorneyId, // Use the attorneyId from the template data
  });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-semibold">Anderson Trust Creation</h2>
          <Badge
            variant="secondary"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        ...
        <div>
          ...
          <p className="font-medium">Jack Rustle</p>
        </div>
        <div>
          <span className="text-muted-foreground">Created Date</span>
          <p className="font-medium">1.2.2024</p>
        </div>
      </div>
