      ...
      <div className="bg-white min-h-screen">
        <div className="max-w-5xl mx-auto px-6 py-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            >
              <ChevronLeft className="h-5 w-5" />
              <span className="ml-1">Create Campaign Questionnaire</span>
            </Button>
          </div>
          ...
          <div>
            <div className="mb-6 grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-sm">Empowerment of Citizens through Legal Awareness and Outreach</div>
              </div>
              <div>
            ...
            <Tabs defaultValue="contact" className="w-full" onValueChange={setActiveTab}>
              <TabsList className="w-auto border-b mb-6">
                <TabsTrigger 
                  value="contact"
                  className="px-4 py-2 data-[state=active]:border-b-2 data-[state=active]:border-blue-800 rounded-none bg-transparent"
                >
                  Common Variables
                </TabsTrigger>
                <TabsTrigger 
